...
class EpisodeServers extends Component {
  ...
  render() {
    ...
    if(server == 1) {
      ...
      const link = `//www.2embed.cc/embedtv/${showId}&s=${seasonNumber}&e=${episodeNumber}`;      
      player = (
      <>
                <Download
                handleChange={cancelModal}
      ...
      const link = `//player.autoembed.cc/embed/tv/${showId}/${seasonNumber}/${episodeNumber}/`;      
      player = (
      <>
                <Download
                handleChange={cancelModal}
        ...
        <div className={`modal modal--fullscreen ${isVideoOpen}`}>
          ...
          >
            <div>
              ...
              <div>
                <small>VidCloud, 2embed, AutoEmbed</small>
              </div>
